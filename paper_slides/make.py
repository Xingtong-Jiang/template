...
gs.tablefill(template = 'code/tables_ge1960.tex', 
             inputs   = 'input/regression_ge1960.csv', 
             output   = 'output/tables_ge1960_filled.tex')
gs.tablefill(template = 'code/tables_ge1960_cls.tex', 
             inputs   = 'input/regression_ge1960_cls.csv', 
             output   = 'output/tables_ge1960_cls_filled.tex')
